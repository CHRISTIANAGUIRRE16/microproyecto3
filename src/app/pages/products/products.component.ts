...
export class ProductComponent implements OnInit {
  ...
  getProduct(id: ProductModel['id']) {
    ...
    return this.productService.getOne(id).subscribe((response) => {
      console.log(response);
    });
  }
  ...
  updateProduct(id: ProductModel['id'], product:UpdateProductDto) {
    ...
    this.productService.update(id, product).subscribe((response) => {
      console.log(response);
    });
  }
  editProduct() {
...
//taller de los componentes  capturas
// verificar  que este actualizada product.service  / product.component
